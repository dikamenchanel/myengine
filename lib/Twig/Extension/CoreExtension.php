...
use lib\Twig\ExpressionParser;
use lib\Twig\Node\Expression\Binary\AddBinary;
use lib\Twig\Node\Expression\Binary\AndBinary;
use lib\Twig\Node\Expression\Binary\BitwiseAndBinary;
use lib\Twig\Node\Expression\Binary\BitwiseOrBinary;
use lib\Twig\Node\Expression\Binary\BitwiseXorBinary;
use lib\Twig\Node\Expression\Binary\ConcatBinary;
use lib\Twig\Node\Expression\Binary\DivBinary;
use lib\Twig\Node\Expression\Binary\EndsWithBinary;
use lib\Twig\Node\Expression\Binary\EqualBinary;
use lib\Twig\Node\Expression\Binary\FloorDivBinary;
use lib\Twig\Node\Expression\Binary\GreaterBinary;
use lib\Twig\Node\Expression\Binary\GreaterEqualBinary;
use lib\Twig\Node\Expression\Binary\HasEveryBinary;
use lib\Twig\Node\Expression\Binary\HasSomeBinary;
use lib\Twig\Node\Expression\Binary\InBinary;
use lib\Twig\Node\Expression\Binary\LessBinary;
use lib\Twig\Node\Expression\Binary\LessEqualBinary;
use lib\Twig\Node\Expression\Binary\MatchesBinary;
use lib\Twig\Node\Expression\Binary\ModBinary;
use lib\Twig\Node\Expression\Binary\MulBinary;
use lib\Twig\Node\Expression\Binary\NotEqualBinary;
use lib\Twig\Node\Expression\Binary\NotInBinary;
use lib\Twig\Node\Expression\Binary\OrBinary;
use lib\Twig\Node\Expression\Binary\PowerBinary;
use lib\Twig\Node\Expression\Binary\RangeBinary;
use lib\Twig\Node\Expression\Binary\SpaceshipBinary;
use lib\Twig\Node\Expression\Binary\StartsWithBinary;
use lib\Twig\Node\Expression\Binary\SubBinary;
use lib\Twig\Node\Expression\Filter\DefaultFilter;
use lib\Twig\Node\Expression\NullCoalesceExpression;
use lib\Twig\Node\Expression\Test\ConstantTest;
use lib\Twig\Node\Expression\Test\DefinedTest;
use lib\Twig\Node\Expression\Test\DivisiblebyTest;
use lib\Twig\Node\Expression\Test\EvenTest;
use lib\Twig\Node\Expression\Test\NullTest;
use lib\Twig\Node\Expression\Test\OddTest;
use lib\Twig\Node\Expression\Test\SameasTest;
use lib\Twig\Node\Expression\Unary\NegUnary;
use lib\Twig\Node\Expression\Unary\NotUnary;
use lib\Twig\Node\Expression\Unary\PosUnary;
use lib\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use lib\Twig\TokenParser\ApplyTokenParser;
use lib\Twig\TokenParser\BlockTokenParser;
use lib\Twig\TokenParser\DeprecatedTokenParser;
use lib\Twig\TokenParser\DoTokenParser;
use lib\Twig\TokenParser\EmbedTokenParser;
use lib\Twig\TokenParser\ExtendsTokenParser;
use lib\Twig\TokenParser\FlushTokenParser;
use lib\Twig\TokenParser\ForTokenParser;
use lib\Twig\TokenParser\FromTokenParser;
use lib\Twig\TokenParser\IfTokenParser;
use lib\Twig\TokenParser\ImportTokenParser;
use lib\Twig\TokenParser\IncludeTokenParser;
use lib\Twig\TokenParser\MacroTokenParser;
use lib\Twig\TokenParser\SetTokenParser;
use lib\Twig\TokenParser\UseTokenParser;
use lib\Twig\TokenParser\WithTokenParser;
use lib\Twig\TwigFilter;
use lib\Twig\TwigFunction;
use lib\Twig\TwigTest;
...
namespace {
    ...
    use lib\Twig\Extension\CoreExtension;
    use lib\Twig\Extension\SandboxExtension;
    use lib\Twig\Markup;
    use lib\Twig\Source;
    use lib\Twig\Template;
    use lib\Twig\TemplateWrapper;
