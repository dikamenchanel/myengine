...
class CommentsController extends AdminController
{
    ...
    function addAction($urlCategory)
    {
        ...
        $Form->addSelect('author_id', [], 'Автор статьи');
        $Form->addSelect('category_id', [], 'Категория статьи');
    ...
    function editAction($urlCategory, $id)
    {
        ...
        if($Article)
        {
            ...
            $Form->addSelect('author_id', [], 'Автор статьи', $Article['author_id']);
            $Form->addSelect('category_id', [], 'Категория статьи', $Article['category_id']);
